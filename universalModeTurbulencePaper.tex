...
\changed{In the context of sheared flows in neutral fluids, a
  ...
  compared to the zero-shear case.  Indeed, when the shear changes
  from 0 to any small finite value, the eigenvalues (for a range of
  $k_y$) appear to change from unstable to stable discontinuously
  rather than continuously \cite{Ross,Tsang}.  Thus, it may or may not
  be possible to analyze the role of magnetic shear in the universal
  instability using the formal theory of pseudospectra, and we leave
  this careful mathematical analysis for future work.  }
